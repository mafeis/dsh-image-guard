...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			markerLang: "标记语言",
			markerLangHint: "决定默认模板与标记正文（身份、取回提示）的语言；切换时会同步把仍是默认值的模板换掉。",
			markerZh: "中文",
			markerEn: "English",
			preview: "预览",
			pmFull: "完整绝对路径",
		...
		var en = {
			...
			markerLangHint: "Sets the language of the default template and of the marker body (identity and retrieval hint). Switching also replaces a template that is still a default.",
			markerZh: "Chinese",
			markerEn: "English",
			preview: "Preview",
		...
		function useGuard() {
			...
			var [markerLang, setMarkerLang] = React.useState("zh");
			...
			return {
				...
				placeholder: placeholder, setPlaceholder: setPlaceholder, markerLang: markerLang, setMarkerLang: pickMarkerLang,
					...
					jx.jsx("div", {
						...
						children: [
							...
							jx.jsx(Field, {
								...
								children: [
									jx.jsx("textarea", { className: "ig-in ig-mono", rows: 2, value: g.placeholder, placeholder: defaultTemplate(g.markerLang), onChange: function (e) { g.setPlaceholder(e.target.value); g.dirty(); } }),
									jx.jsx("div", { className: "ig-preview", children: [jx.jsx("em", { children: t("preview") }), jx.jsx("span", { children: previewMarker(g.placeholder, g.pathMode, g.markerLang) })] }),
								],
							}),
						],
					}),
